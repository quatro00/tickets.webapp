...
@Component({
  ...
  templateUrl: './en-espera-ticket.component.html',
  styleUrl: './en-espera-ticket.component.scss'
})
export class EnEsperaTicketComponent implements OnInit {
  form: FormGroup;
  ticketId: any = '';
  constructor(
    public dialogRef: MatDialogRef<EnEsperaTicketComponent>,
