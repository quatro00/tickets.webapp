...
@Component({
  ...
  templateUrl: './resolver-ticket.component.html',
  styleUrl: './resolver-ticket.component.scss'
})
export class ResolverTicketComponent  implements OnInit {
  form: FormGroup;
  ticketId: any = '';
  constructor(
    public dialogRef: MatDialogRef<ResolverTicketComponent>,
