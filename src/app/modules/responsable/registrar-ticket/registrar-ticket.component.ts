...
export class RegistrarTicketComponent implements OnInit {
  ...
  constructor(
    ...
    private catCategoriaService: Responsable_CatCategoriaService,
    private catPrioridadService: Responsable_CatPrioridadService,
    private organizacionService:Responsable_OrganizacionService,
    private ticketService: Responsable_TicketService,
    private areaService: Responsable_AreaService,
